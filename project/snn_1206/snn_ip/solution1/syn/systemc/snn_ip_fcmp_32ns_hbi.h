...
// ==============================================================
#ifndef __snn_ip_fcmp_32ns_hbi__HH__
#define __snn_ip_fcmp_32ns_hbi__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(snn_ip_fcmp_32ns_hbi) {
    ...
    SC_CTOR(snn_ip_fcmp_32ns_hbi):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
