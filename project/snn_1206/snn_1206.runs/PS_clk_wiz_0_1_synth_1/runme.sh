...
HD_PWD='C:/snn_1206/snn_1206.runs/PS_clk_wiz_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PS_clk_wiz_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PS_clk_wiz_0_1.tcl
