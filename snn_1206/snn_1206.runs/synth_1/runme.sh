...
HD_PWD='C:/snn_1206/snn_1206.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FMC_LCD_test_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FMC_LCD_test_top.tcl
