...
HD_PWD='C:/snn_1206/snn_1206.runs/PS_fifo_generator_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PS_fifo_generator_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PS_fifo_generator_0_0.tcl
